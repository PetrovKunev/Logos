                ...
                {course.category === 'Програмиране' && (
                  <div className={`${theme.accentBgLight} border ${theme.accentBorderLight} rounded-lg p-6 mb-8`}>
                    ...
                    <p className={`${theme.accentTextLight} mb-3`}>
                      Обучението води <strong>действащ учител по C# в гимназия</strong>, който работи в
                      областта на изкуствения интелект в образованието. От новата учебна година
                      учениците предават задачите си в{' '}
